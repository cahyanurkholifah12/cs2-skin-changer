...
<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>Cs2Skins</code> &nbsp;·&nbsp; <code>cs2skins</code>
</p>
...
CS2 skin changer module — inventory spoof tab, knife model swap, wear float UI.

Skin changer is its own search funnel separate from full cheats.
...
```bash
dotnet restore cs2-skin-changer.slnx
dotnet build cs2-skin-changer.slnx -c Release
dotnet test cs2-skin-changer.slnx -c Release
```
